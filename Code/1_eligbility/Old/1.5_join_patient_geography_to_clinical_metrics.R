...
# `komodo_202606.patient_geography` where the patient spent the longest clipped
...
#
# Run this after:
#   - Code/1_eligbility/Old/1.4_filter_clinical_metrics_to_non_inpatient_claim_eligible.R
...
if (!table_exists(con, source_eligibility_schema, source_eligibility_table)) {
  stop(
    ...
    ".",
    source_eligibility_table,
    ". Run Code/1_eligbility/Old/1.4_filter_clinical_metrics_to_non_inpatient_claim_eligible.R first."
  )
}
