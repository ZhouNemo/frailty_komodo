...
# `komodo_202606.non_inpatient_events`, and writes a restricted upstream
...
#   - Code/1_eligbility/Old/1.2_check_annual_eligible_population.R
#   - Code/1_eligbility/Old/1.3_join_race_ethnicity_to_eligible_cohort.R
