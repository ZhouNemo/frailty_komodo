...
# Code/2_EDA/4.2_visualize_annual_clinical_metrics_descriptive_outputs.Rmd from
# aggregate outputs already written by Code/2_EDA/4.1_describe_annual_clinical_metrics.R.
