...
# Project: Frailty_Komoto optimized annual CCW variables
# Author: Nemo Zhou
# Date started: 2026-06-29
# Date last updated: 2026-06-29
#
# ---- Purpose ----
# Calculate CCW variables for the optimized 6.x pipeline from compact CCW
# feature matches. This wrapper reuses the validated `Code/5.4` logic while
# pointing it at:
...
tryCatch(
  source("Code/5.4_calculate_annual_ccw_variables.R"),
  finally = options(
